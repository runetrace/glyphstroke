...
internal static class L
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["Пауза, мс"] = "Delay, ms",
        ["Ничего"] = "Nothing",
        // редактор действий: выбор файла, списки и подсказки-плейсхолдеры
        ["Обзор…"] = "Browse…",
        ["Выбрать программу или файл"] = "Choose a program or file",
        ["Программы"] = "Programs",
        ["Все файлы"] = "All files",
        ["число щелчков (необязательно)"] = "clicks (optional)",
        ["Свернуть"] = "Minimize",
        ["Развернуть"] = "Maximize",
        ...
        ["Влево"] = "Left",
        ["Вправо"] = "Right",
        ["напр. ctrl+c ctrl+v"] = "e.g. ctrl+c ctrl+v",
        ["текст для вставки"] = "text to insert",
        ["команда или путь (или «Обзор…»)"] = "command or path (or Browse…)",
        ["имя/путь или «Обзор…»"] = "name/path or Browse…",
        ["мс, напр. 200"] = "ms, e.g. 200",
        // настройки
        ["Мышь"] = "Mouse",
